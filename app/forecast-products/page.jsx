...
export default function ForecastProducts(){
 ...
 return <main className={styles.wrap}>
  ...
  </article>)}</section>:<section className={styles.empty}><h3>No evidence-qualified active Top 100 yet</h3><p>The autonomous agent will not fabricate products or relax the €20, Greece-scarcity or five-category gates just to fill 100 rows.</p></section>}
 </main>
}
