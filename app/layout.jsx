...
export default function RootLayout({children}){
  return <html lang="el"><body><div className="shell">
    <nav className="nav"><Link className="brand" href="/">SocialMarket AI</Link><div className="navlinks"><Link href="/market">Market Map</Link><Link href="/niches">Niches</Link><Link href="/merchants">Merchants</Link><Link href="/products">Products</Link><Link href="/creatives">Creatives</Link><Link href="/scheduler">Social Scheduler</Link><Link href="/tiktok">TikTok Studio</Link></div></nav>
