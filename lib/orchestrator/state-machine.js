...
const ALLOWED = {
  ...
  EXECUTING:['WAITING_TOOL','VERIFYING','WAITING_APPROVAL','FAILED'],
  WAITING_TOOL:['EXECUTING','VERIFYING','FAILED'],
  VERIFYING:['DEPLOYING','MEASURING','COMPLETE','WAITING_TOOL','FAILED'],
  DEPLOYING:['VERIFYING','MEASURING','WAITING_TOOL','FAILED'],
  MEASURING:['COMPLETE','REPLAN','WAITING_TOOL','FAILED'],
