...
from pain_grouping_embedding import embedding_group_pains
from deep_validation import deep_then_contradict
...
_original_contradiction = core.contradiction_check
...
core.PAIN_RE = ConcretePainMatcher()
...
core.group_pains = lambda evidence_rows, agent_runtime, run_id: embedding_group_pains(
    core, evidence_rows, agent_runtime, run_id, _original_group
)
core.contradiction_check = lambda run_id, pain, max_pages=2: deep_then_contradict(
    core, _original_contradiction, run_id, pain, max_pages=max_pages
)
